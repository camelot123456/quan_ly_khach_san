...
public class ServiceController {
	...
	public ResponseEntity<?> doCreate(@RequestPart("service") ServiceEntity service) {
		return ResponseEntity.ok().body(serviceServ.save(service));
	}
	
	@DeleteMapping("/services/delete")
	public ResponseEntity<?> doDelete(@RequestBody EntityResponse entity) {
		serviceServ.deleteById(entity.getId());
